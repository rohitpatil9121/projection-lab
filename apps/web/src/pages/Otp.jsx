  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-5 bg-ink-50 dark:bg-ink-950">
      <div className="card w-full max-w-md shadow-soft">
        ...
        <p className="text-sm text-ink-400 mt-1">Sent to <span className="font-semibold text-ink-700 dark:text-ink-200">{email}</span></p>
        {state?.devOtp && (
        ...
        <Link to="/login" className="block text-center text-sm font-semibold text-brand-600 mt-4">Use a different email</Link>
      </div>
    </div>
  )
}
